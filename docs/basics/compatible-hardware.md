...
[RGB2Go Duo2Go Controller](https://rgb2go.com/products/duo2go-pixel-controller) | Elegantly simple THT design making repair and modification easy. Supports 5V and 12V  pixels. Supports up to 5A per output. 33ohm resistors and a SN74AHCT125N IC buffer ensure data can travel over 50ft from the controller over standard 3-wire xConnect extension cables without the need for a data-booster or F-Amp.
